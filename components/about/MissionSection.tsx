  ...
  return (
    ...
    <section ref={containerRef} className="w-full py-24">
      <div className="max-w-5xl mx-auto text-center px-4 md:px-0">
        <p className="text-2xl sm:text-3xl lg:text-4xl text-gray-600 leading-[1.2] font-normal mt-4">
          {words.map((word, i) => {
      ...
      <div className="px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="flex flex-col text-center">
            <div className="text-[56px] md:text-[72px] text-gray-600 leading-none mb-2 tracking-tight">
